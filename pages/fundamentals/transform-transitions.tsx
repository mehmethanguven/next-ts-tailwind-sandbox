  ...
  return (
    <div>
      ...
      <Card>
        ...
        <button className="m-24 rounded bg-blue-500 px-8 py-2 text-white transition-colors duration-700 hover:bg-blue-700 dark:bg-slate-500 dark:hover:bg-cyan-800">
          Transition
        </button>
        <button className="m-24 rounded bg-blue-500 px-8 py-2 text-white transition delay-150 duration-2000 ease-in-out hover:-translate-y-1 hover:scale-110 hover:bg-indigo-500 dark:bg-slate-500 dark:hover:bg-cyan-800">
          Transition & Transform
        </button>
      </Card>
      <Card title="transform & transition">
        <Image
          width={0}
          height={0}
          alt=""
          src="/images/img1.jpg"
          sizes="100vh"
          className="w-96 transition duration-2000 hover:rotate-180 hover:skew-x-12 hover:scale-75 hover:transform"
        />
      </Card>
    </div>
  )
...
export default TransformTransitions
